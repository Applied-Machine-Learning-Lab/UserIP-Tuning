...
class UIPrompt:
    ...
    def init_prompt(self, nuser, nitem):
        ...
        self.user_embeddings_hobby = nn.Embedding(nuser, emsize) # 根据hobby即用户爱好品牌所学习的latent concept variable
        self.user_embeddings_background = nn.Embedding(nuser, emsize) # 根据price即 用户背景——消费价格所学习的latent concept variable
